...
DATA = json.load(open(os.path.join(ROOT, "content", "moods.json"), encoding="utf-8"))
...
%s
    ...
    <a class="nav-cta" href="/#finder" data-track="mood_finder_started" data-track-from="nav">Find my mood</a>
  </div>
</nav>""" % "\n".join(links)
...
def build_data_js():
    ...
    write("moods-data.js",
          "/* Generated by tools/build.py from content/moods.json. Do not edit. */\n"
